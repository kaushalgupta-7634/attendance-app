...
class DeviceAntiProxyTest {
    ...
    void testAntiProxyDeviceCheck_RejectsSecondStudentOnSameDevice() {
        ...
        String code = qrCodeService.generateCurrentPasscode(activeSession.getId());

        // Step 1: Student 1 marks attendance on device
        MarkAttendanceRequest req1 = new MarkAttendanceRequest(code, 28.6139, 77.2090, activeSession.getId());
        ...
        MarkAttendanceRequest req2 = new MarkAttendanceRequest(code, 28.6139, 77.2090, activeSession.getId());
