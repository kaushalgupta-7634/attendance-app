    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/", "/index.html", "/login.html", "/forgot-password.html", "/reset-password.html", "/teacher-dashboard.html", "/student-scan.html", "/admin-dashboard.html", "/auth/**", "/api/auth/**", "/api/info", "/favicon.ico", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-ui.html", "/assignments/download/**", "/assignments/class/**").permitAll()
